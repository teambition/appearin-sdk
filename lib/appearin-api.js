...
function AppearinApi(config) {
    config = config || {};
    this.namespace = config.namespace;
    this.stunServer = config.stunServer;
}

AppearinApi.prototype.isWebRtcCompatible = function isWebRtcCompatible() {
    try {
...
AppearinApi.prototype.getRandomRoomName = promise.nodeify(function getRandomRoomName() {
    return req({
        method: "POST",
...
AppearinApi.prototype.addRoomToIframe = function addRoomToIframe(iframe, roomName) {
    if (!iframe || !roomName) {
...
AppearinApi.prototype.addRoomToElementById = function addRoomToElementById(id, roomName) {
    if (!id || !roomName) {
        throw new Error("Missing parameters");
    }
